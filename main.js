const textEl = document.getElementById("string");
const vowelEl = document.getElementById("vowel");
const consEl = document.getElementById("consonent");
const digitsEl = document.getElementById("digits");
const sCharEl = document.getElementById("schar");
...
const checkStuff = function (text) {
  ...
  return [vCount, cCount, sCount, dCount, text.length];
};
...
const calc = function calc() {
  ...
  total.innerText = checkStuff(text)[4];
};
